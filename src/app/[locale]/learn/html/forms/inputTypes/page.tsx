...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    return getPageMetadata({
        ...
        slug: "learn/html/forms/inputTypes",
    });
}

export default async function HTMLInputTypesPage({ params }: { params: { locale: string } }) {
    const { locale } = await params;
    const t = await getTranslations({ locale: locale, namespace: "html.formTags.inputTypes" });
